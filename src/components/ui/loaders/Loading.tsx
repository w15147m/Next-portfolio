...
function Loading({ msg }: props) {
  return (
    <div className="w-full flex justify-center items-center border-t border-gray-100 p-6 dark:border-gray-800">
      <button type="button" className="flex items-center justify-center gap-2 rounded-lg  px-5 py-3.5 text-lg font-medium  text-gray-700  dark:bg-gray-800 dark:text-gray-400">
        <span className="animate-spin stroke-brand-500 text-gray-200 dark:text-gray-800">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="10" cy="10" r="8.75" stroke="currentColor" strokeWidth="2.5"></circle>
