...
import { deleteExperience } from "../_lib/actions";
  ...
  const handleDelete = async () => {
    try {
      ...
      if (result.success) {
        ...
        showToast(result.message || "Failed to delete experience record", "error");
      }
    } finally {
      setIsLoading(false);
    }
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[440px] p-6">
        <div className="text-center">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
            Are you sure you want to delete experience record for{" "}
