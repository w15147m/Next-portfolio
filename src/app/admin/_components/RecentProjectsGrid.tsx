  ...
  return (
    <div className="rounded-2xl bg-[#091515] border border-[#163533] p-5 h-full flex flex-col shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
      ...
      <div className="relative flex-1 flex items-center">
        {/* Left Arrow */}
        <button className="absolute left-0 z-20 w-8 h-8 -ml-3 bg-[#061011] border border-[#163533] rounded-full flex items-center justify-center text-teal-600 hover:text-teal-400 hover:border-teal-500/50 transition-colors shadow-lg">
        ...
        {/* Right Arrow */}
        <button className="absolute right-0 z-20 w-8 h-8 -mr-3 bg-[#061011] border border-[#163533] rounded-full flex items-center justify-center text-teal-600 hover:text-teal-400 hover:border-teal-500/50 transition-colors shadow-lg">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
