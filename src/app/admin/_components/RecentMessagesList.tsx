            ...
            <div key={msg.id} className="flex items-center justify-between group">
              <div className="flex items-center gap-3 min-w-0">
                <div className="shrink-0">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-[11px] ${msg.isRead ? 'bg-gray-100 dark:bg-[#122e2b] text-gray-500 dark:text-teal-700' : 'bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 border border-teal-200 dark:border-teal-500/30'}`}>
              ...
              <div className="shrink-0 flex flex-col items-end justify-center ml-2">
                ...
                {!msg.isRead && (
                  <div className="w-1.5 h-1.5 rounded-full bg-teal-500 dark:bg-teal-400 shadow-[0_0_8px_rgba(20,184,166,0.5)] dark:shadow-[0_0_8px_rgba(45,212,191,0.8)]" />
                )}
              </div>
            </div>
          )
