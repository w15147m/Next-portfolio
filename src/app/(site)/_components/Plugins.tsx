...
export default function Plugins() {
  return (
    <section className="bg-white dark:bg-gray-900 dark:border-gray-800 pt-16 md:pt-24 lg:pt-30">
      <div className="container mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-12 w-full max-w-[770px] text-center lg:mb-15"><span
            className="mb-5 inline-block text-lg font-medium text-primary">Powerful Toolkit</span>
          <h2 className="text-3xl font-bold !leading-[1.2] text-title-color dark:text-white/90 md:text-[40px]">Customized Plugins and Add-ons
          </h2>
        </div>
      </div>
      <div className="container mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
